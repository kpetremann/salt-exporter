...
func TestMetrics(t *testing.T) {
	...
	expected := map[string][]Metric{
		...
		"execution modules": {
			{"salt_new_job_total", map[string]string{"function": "test.exception", "state": "", "success": "true"}, 1},
			{"salt_new_job_total", map[string]string{"function": "test.true", "state": "", "success": "true"}, 1},
		...
		"state modules": {
			{"salt_new_job_total", map[string]string{"function": "state.single", "state": "test.succeed_with_changes", "success": "true"}, 1},
			{"salt_new_job_total", map[string]string{"function": "state.single", "state": "test.fail_with_changes", "success": "true"}, 1},
		...
		"states": {
			{"salt_new_job_total", map[string]string{"function": "state.sls", "state": "test.succeed", "success": "true"}, 1},
			{"salt_new_job_total", map[string]string{"function": "state.sls", "state": "test.fail", "success": "true"}, 1},
